...
def provide_user_client(settings: AdminServiceSettings) -> UserServiceClient | StubUserServiceClient:
...
def provide_billing_client(settings: AdminServiceSettings) -> BillingServiceClient | StubBillingServiceClient:
...
def provide_vpn_client(settings: AdminServiceSettings) -> VPNServiceClient | StubVPNServiceClient:
